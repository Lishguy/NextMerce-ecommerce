        ...
        <div className="py-16 md:py-6 items-center justify-center flex mx-auto px-4">
          <div className="bg-white rounded-md  w-full md:w-[40%] py-7 flex items-center">
            ...
            <div className="flex flex-col w-full mx-5 md:mx-10">
              ...
              {/* Button  */}
              <div className="bg-blue-950 hover:bg-blue-700 cursor-pointer text-white text-center font-semibold rounded-full w-full py-3 mt-5">
                Sign In
              </div>

              {/* forgot password  */}
              <div className="flex flex-col mt-3">
                <p className="text-center text-gray-400 hover:text-black cursor-pointer">
                ...
                <div className="flex items-center text-center gap-2 justify-center border mt-5 py-3 rounded-full bg-gray-50 hover:bg-gray-100/90 cursor-pointer">
                  <Image src={google} alt="google" className="w-5" />
                  <p>Sign In with Google</p>
                </div>
                <div className="flex items-center text-center justify-center border mt-3 py-3 rounded-full gap-2 bg-gray-50 hover:bg-gray-100/90 cursor-pointer">
