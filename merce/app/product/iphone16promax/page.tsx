...
const Iphone16promax = () => {
  ...
  const product = newarrivals.find((item) => item.id === "16promax");
        ...
        <div className="flex flex-col lg:flex-row px-6 xl:px-0 gap-9 xl:gap-14 w-full">
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex gap-2 md:gap-5 mt-3">
              ...
              <div className="text-sm md:text-md">( 3 customer reviews )</div>
            ...
            <div className="flex gap-1 mt-5">
              ...
              <span className="text-xl md:text-2xl font-semibold">$899</span>
            </div>
            ...
            <div className="flex items-center gap-8 mt-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  className="h-5 w-5 rounded-full bg-blue-700 cursor-pointer flex items-center justify-center"
                >
                  {selectedColor === 1 && (
                    <Check size={16} className="text-white font-bold" />
                  )}
