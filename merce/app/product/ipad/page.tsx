...
import product9 from "../../../public/images/newarrival5.png";
import product10 from "../../../public/images/ipad gray.png";
...
const Ipad = () => {
  ...
  const product = newarrivals.find((item) => item.id === "ipad");
        ...
        <div className="flex flex-col lg:flex-row px-6 xl:px-0 gap-9 xl:gap-14 w-full">
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex gap-2 md:gap-5 mt-3">
              ...
              <div className="text-sm md:text-md">( 1 customer reviews )</div>
            ...
            <div className="flex flex-col gap-4 mt-6">
              ...
              <div className="flex gap-2 items-center">
                <CircleCheck size={20} className="text-blue-700" />
                <p className="text-md">Other Offers</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-8 mt-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  className="h-5 w-5 rounded-full bg-cyan-200/90 cursor-pointer flex items-center justify-center"
                >
                  {selectedColor === 0 && (
        ...
        {activeTab === "additional" && (
          <div className="flex flex-col gap-1 mt-10 bg-white rounded-md py-9 px-5">
            <div className="grid grid-cols-2 md:grid-cols-3 items-center px-6">
              <span className="text-gray-700">test attribute</span>
              <span className="text-gray-600">Test Attribute</span>
              <span></span>
            </div>
          </div>
        )}
