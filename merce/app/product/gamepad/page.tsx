...
import product9 from "../../../public/images/console.png";
import product10 from "../../../public/images/game.png";
...
const Gamepad = () => {
  ...
  const product = newarrivals.find((item) => item.id === "gamepad");
        ...
        <div className="flex flex-col lg:flex-row px-6 xl:px-0 gap-9 xl:gap-14 w-full">
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex gap-1 mt-5">
              ...
              <span className="text-xl md:text-2xl font-semibold">$26</span>
            </div>
            ...
            {/* Dpad */}
            <div className="flex items-center mt-5">
              <h1 className="font-semibold mr-10">D-Pad:</h1>
        ...
        {activeTab === "additional" && (
          <div className="flex flex-col gap-1 mt-10 bg-white rounded-md py-7 px-5">
            <div className="grid grid-cols-2 md:grid-cols-3 items-center px-6 py-4">
              ...
              <span className="text-gray-600">12 Keys</span>
              <span></span>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 items-center bg-gray-50 px-6 py-4 rounded-md">
              <span className="text-gray-700">Nubers of buttons</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 items-center px-6 py-4">
              ...
              <span className="text-gray-600">D-Pad: YES Mini Stick: 2</span>
              <span></span>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 items-center bg-gray-50 px-6 py-4 rounded-md">
              <span className="text-gray-700">Brand</span>
              <span className="text-gray-600">Havit</span>
              <span></span>
            </div>
          </div>
        )}
