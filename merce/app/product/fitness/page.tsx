...
import product9 from "../../../public/images/newarrival2.png";
import product10 from "../../../public/images/gymm.png";
...
const page = () => {
  ...
  const product = newarrivals.find((item) => item.id === "fitness");
            ...
            <div className="flex gap-4">
              ...
              <div
                ...
                className={`bg-gray-100 px-8 py-8 rounded-lg cursor-pointer
                    ${currentImageIndex === 0 ? "border-2 border-blue-700" : "hover:border-2 hover:border-blue-700"}`}
              >
              ...
              <div
                ...
                className={`bg-gray-100 px-8 py-8 rounded-lg cursor-pointer
                    ${currentImageIndex === 1 ? "border-2 border-blue-700" : "hover:border-2 hover:border-blue-700"}`}
              >
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex justify-between items-center gap-1">
              <h1
                ...
                "
              >
                Indoor Steel Adjustable Silent Treadmill Home Fitness
              </h1>
            ...
            <div className="flex gap-1 mt-5">
              ...
              <span className="text-xl md:text-2xl font-semibold">$888</span>
            </div>
