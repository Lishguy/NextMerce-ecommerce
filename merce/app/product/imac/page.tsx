...
import product10 from "../../../public/images/imac.png";
...
const Imac = () => {
  ...
  const product = newarrivals.find((item) => item.id === "imac");
  ...
  return (
    <div>
        ...
        <div className="flex flex-col lg:flex-row px-6 xl:px-0 gap-9 xl:gap-14 w-full">
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex justify-between items-center">
              <h1 className="text-xl md:text-2xl xl:text-[40px] font-semibold text-black/80">
                Apple iMac M4 24-inch 2025
              </h1>
              <button className="bg-blue-700 text-white text-[12px] xl:text-[11px] font-medium px-2 py-0.5  rounded-full">
                30% OFF
              </button>
            </div>
            {/* start  */}
            ...
            <div className="flex gap-1 mt-5">
              ...
              <span className="text-xl md:text-2xl font-semibold">$333</span>
            </div>

            <div className="flex flex-col gap-4 mt-6">
              <div className="flex gap-2 items-center">
                <CircleCheck size={20} className="text-blue-700" />
                <p className="text-md">Free delivery available</p>
              </div>

              <div className="flex gap-2 items-center">
                <CircleCheck size={20} className="text-blue-700" />
                <p className="text-md">Sales 30% Off Use Code: PROMO30</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-8 mt-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  className="h-5 w-5 rounded-full bg-gray-500/80 cursor-pointer flex items-center justify-center"
                >
                  {selectedColor === 0 && (
            ...
            <div className="flex items-center gap-10 mt-5">
              ...
              <button
                onClick={() => setIsSizeSelected(!isSizeSelected)}
                className={`px-3 text-[17px] rounded-full border cursor-pointer transition
                        ${
                          isSizeSelected
                            ? "bg-blue-700 text-white border-blue-700"
                            : "bg-gray-50/70 border-gray-300 hover:border-blue-700 hover:text-blue-700"
                        }
                        `}
              >
                533
      ...
      <div className="bg-gray-100/90 mt-10 py-20 mb-16 w-full">
        ...
        {activeTab === "description" && (
          <div className="flex flex-col gap-8 w-full lg:w-[50%] mt-10 px-4 xl:px-0">
            ...
            <p className="text-md text-gray-500">
              ...
              ipsum at risus euismod lobortis in sit amet velit. Donec lacinia
              porttitor nibh eu vestibulum. Proin at commodo metus. Nunc sit
              amet condimentum leo. Suspendisse metus massa, ultricies ut
              iaculis id, elementum ac neque. In elit metus, rutrum at neque
              nec, iaculis eleifend leo.
            </p>
            <p className="text-md text-gray-500">
              Sed elementum nunc ut libero congue, at faucibus est commodo. Sed
              malesuada facilisis felis eget pellentesque. Phasellus leo erat,
              maximus ut commodo nec, efficitur et ex. Nulla gravida volutpat
              maximus. Ut at blandit nisl, eget aliquet augue. Donec non dolor
              nisl.Integer elementum iaculis nibh, quis mattis nulla dictum nec.
              Praesent suscipit felis faucibus, iaculis arcu id, rhoncus eros.
              Sed maximus orci at urna vestibulum, ut ullamcorper augue
              vestibulum. Aenean ullamcorper eu nisl sed posuere.
            </p>
          </div>
        )}
        ...
        {/* Additional Info */}
        {activeTab === "additional" && (
          <div className="flex flex-col gap-1 mt-10 bg-white rounded-md py-7 px-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 items-center bg-gray-50 px-6 py-4 rounded-md">
              <span className="text-gray-700">Model</span>
              <span className="text-gray-600">Apple iMac M1</span>
              <span></span>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 items-center px-6 py-4">
              <span className="text-gray-700">Size</span>
              <span className="text-gray-600">20 Inches</span>
              <span></span>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 items-center bg-gray-50 px-6 py-4 rounded-md">
              <span className="text-gray-700">Chipset</span>
              <span className="text-gray-600">Apple A15 Bionic (5 nm)</span>
              <span></span>
            </div>
          </div>
        )}
