...
import product9 from "../../../public/images/newarrival6.png";
import product10 from "../../../public/images/series7.png";
...
const Applewatch = () => {
  ...
  const product = newarrivals.find((item) => item.id === "applewatch");
  ...
  const handleAddToCart = (item = product) => {
    ...
    addToCart({
      ...
      image: item.image.src, // ✅ ALWAYS STRING
    });
        ...
        <div className="flex flex-col lg:flex-row px-6 xl:px-0 gap-9 xl:gap-14 w-full">
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex gap-1 mt-5">
              ...
              <span className="text-xl md:text-2xl font-semibold">$89</span>
            </div>
            ...
            <div className="flex flex-col gap-4 mt-6">
              ...
              <div className="flex gap-2 items-center">
                <CircleCheck size={20} className="text-blue-700" />
                <p className="text-md">Sales 30% Off</p>
              </div>
            ...
            <div className="flex items-center gap-8 mt-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  className="h-5 w-5 rounded-full bg-amber-600/80 cursor-pointer flex items-center justify-center"
                >
                  {selectedColor === 1 && (
                    <Check size={16} className="text-white font-bold" />
                  )}
