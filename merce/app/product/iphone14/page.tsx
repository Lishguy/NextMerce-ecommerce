...
import product9 from "../../../public/images/newarrival4.png";
import product10 from "../../../public/images/iphone 13.png";
...
const page = () => {
  ...
  const product = newarrivals.find((item) => item.id === "16pro");
        ...
        <div className="flex flex-col lg:flex-row px-6 xl:px-0 gap-9 xl:gap-14 w-full">
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex gap-1 mt-5">
              ...
              <span className="text-xl md:text-2xl font-semibold">$600</span>
            </div>
            ...
            <div className="flex items-center gap-8 mt-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  className="h-5 w-5 rounded-full bg-blue-300 cursor-pointer flex items-center justify-center"
                >
                  {selectedColor === 0 && (
                ...
                <div
                  ...
                  className="h-5 w-5 rounded-full bg-pink-300 cursor-pointer flex items-center justify-center"
                >
                  {selectedColor === 1 && (
                    <Check size={16} className="text-white font-bold" />
                  )}
            ...
            <div className="flex items-center mt-5">
              <h1 className="font-semibold mr-10">Test:</h1>
            ...
            {/* Sim */}
            <div className="flex items-center mt-5">
              <h1 className="font-semibold mr-10">Sim:</h1>
        ...
        {activeTab === "additional" && (
          <div className="flex flex-col gap-1 mt-10 bg-white rounded-md py-7 px-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 items-center bg-gray-50 px-6 py-4 rounded-md">
              ...
              <span className="text-gray-600">iPhone 14</span>
              <span></span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 items-center bg-gray-50 px-6 py-4 rounded-md">
              <span className="text-gray-700">Main Camera</span>
              <span className="text-gray-600">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 items-center px-6 py-4">
              <span className="text-gray-700">Selfie Camera</span>
              <span className="text-gray-600">
