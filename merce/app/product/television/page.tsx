...
import product9 from "../../../public/images/newarrival3.png";
import product10 from "../../../public/images/television.png";
...
const Television = () => {
 ...
 type Review = {
  ...
  const product = newarrivals.find((item) => item.id === "television");
  ...
  return (
    <div>
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex justify-between items-center gap-1">
              <h1
                ...
                "
              >
                Rangs 43 Inch Frameless FHD Double Glass Android TV
              </h1>
            ...
            <div className="flex gap-1 mt-5">
              ...
              <span className="text-xl md:text-2xl font-semibold">$700</span>
            </div>
            ...
            <div className="flex items-center gap-8 mt-10">
              ...
              <div className="flex items-center gap-3">
                ...
                <div
                  ...
                  className="h-5 w-5 rounded-full bg-green-600 cursor-pointer flex items-center justify-center"
                >
                  {selectedColor === 1 && (
                    <Check size={16} className="text-white font-bold" />
                  )}
      ...
      <div className="bg-gray-100/90 mt-10 py-20 mb-16 w-full">
        ...
        {/* Description  */}
        {activeTab === "description" && (
          <div className="flex flex-col gap-1 w-full lg:w-[60%] mt-10 px-4 xl:px-0">
            <h1 className="text-2xl text-black/80 font-semibold mb-5">
              Specifications:
            </h1>
