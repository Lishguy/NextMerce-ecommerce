...
import product9 from "../../../public/images/newarrival7.png";
import product10 from "../../../public/images/mac.png";
...
const Macbook = () => {
  ...
  // for routing different productd
  ...
  const product = newarrivals.find((item) => item.id === "macbook");
        ...
        <div className="flex flex-col lg:flex-row px-6 xl:px-0 gap-9 xl:gap-14 w-full">
          ...
          <div className="w-full lg:w-[50%]">
            ...
            <div className="flex gap-1 mt-5">
              ...
              <span className="text-xl md:text-2xl font-semibold">$450</span>
            </div>
            ...
            <div className="flex items-center mt-5">
              <h1 className="font-semibold mr-10">Storage:</h1>

              <div className="flex gap-2">
                <button
                  onClick={() => setSelectedTest("test1")}
                  className={`px-2.5 text-[14px] font-medium rounded-full border cursor-pointer transition
                        ${
                          selectedTest === "test1"
            ...
            {/* screen */}
            <div className="flex items-center mt-5">
              <h1 className="font-semibold mr-10">Screen:</h1>
        ...
        {activeTab === "description" && (
          <div className="flex flex-col gap-8 w-full lg:w-[50%] mt-10 px-4 xl:px-0">
            ...
            <p className="text-md text-gray-500">
              ...
              porttitor nibh eu vestibulum. Proin at commodo metus.
            </p>
            <p className="text-md text-gray-500">
              Nunc sit amet condimentum leo. Suspendisse metus massa, ultricies
              ut iaculis id, elementum ac neque. In elit metus, rutrum at neque
              nec, iaculis eleifend leo. Sed elementum nunc ut libero congue, at
              faucibus est commodo.
            </p>
            <p className="text-md text-gray-500">
              Sed malesuada facilisis felis eget pellentesque. Phasellus leo
              erat, maximus ut commodo nec, efficitur et ex. Nulla gravida
              volutpat maximus. Ut at blandit nisl, eget aliquet augue. Donec
              non dolor nisl. Integer elementum iaculis nibh, quis mattis nulla
              dictum nec. Praesent suscipit felis faucibus, iaculis arcu id,
              rhoncus eros. Sed maximus orci at urna vestibulum, ut ullamcorper
              augue vestibulum. Aenean ullamcorper eu nisl sed posuere.
            </p>
          </div>
        )}
        ...
        {activeTab === "additional" && (
          <div className="flex flex-col gap-1 mt-10 bg-white rounded-md py-7 px-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 items-center bg-gray-50 px-6 py-4 rounded-md">
              ...
              <span className="text-gray-600">MackBook air m1</span>
              <span></span>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 items-center px-6 py-4">
              <span className="text-gray-700">Display Size</span>
              <span className="text-gray-600">15Inch</span>
              <span></span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 items-center bg-gray-50 px-6 py-4 rounded-md">
              <span className="text-gray-700">Display Resolution</span>
              <span className="text-gray-600">
