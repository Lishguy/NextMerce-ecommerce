    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row mt-10 justify-between gap-2 md:gap-0 px-2 items-start md:items-center">
        ...
        <div className="flex gap-2">
          ...
          <p className="text-blue-500 text-sm">Blog Details Sidebar</p>
        </div>
      </div>
              ...
              <div key={index} className="w-full">
                ...
                <div className="mt-7">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="bg-white py-7 px-10 rounded-lg italic  mt-16 text-center">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      In quae accusamus ullam harum nesciunt, molestias aliquam
                      fugiat doloribus blanditiis beatae.
                    </div>
                    ...
                    <div className="flex justify-between items-center mt-10">
                      <div className="flex items-center ">
                        <h1>Tags:</h1>
                        <button className="bg-white hover:bg-blue-700 hover:text-white px-4 py-2 border border-gray-200 ml-4 rounded-full">
                          Lifestyle
                        </button>
                      </div>
